...
var ListActions = function (props) {
    var className = props.className, filtersProp = props.filters, _ = props.hasCreate, _a = props.selectedIds, selectedIds = _a === void 0 ? defaultSelectedIds : _a, _b = props.onUnselectItems, onUnselectItems = _b === void 0 ? defaultOnUnselectItems : _b, rest = __rest(props, ["className", "filters", "hasCreate", "selectedIds", "onUnselectItems"]);
    var _c = (0, ra_core_1.useListContext)(__assign(__assign({}, props), { selectedIds: selectedIds, onUnselectItems: onUnselectItems })), sort = _c.sort, displayedFilters = _c.displayedFilters, filterValues = _c.filterValues, exporter = _c.exporter, showFilter = _c.showFilter, total = _c.total;
...
var defaultOnUnselectItems = function () { return null; };
