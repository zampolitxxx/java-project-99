...
var ArrayInput = function (props) {
    var _a, _b;
    var className = props.className, defaultValue = props.defaultValue, label = props.label, isFetching = props.isFetching, isLoading = props.isLoading, children = props.children, helperText = props.helperText, record = props.record, resourceFromProps = props.resource, source = props.source, validate = props.validate, variant = props.variant, disabled = props.disabled, readOnly = props.readOnly, _c = props.margin, margin = _c === void 0 ? 'dense' : _c, rest = __rest(props, ["className", "defaultValue", "label", "isFetching", "isLoading", "children", "helperText", "record", "resource", "source", "validate", "variant", "disabled", "readOnly", "margin"]);
    ...
    return (React.createElement(Root, __assign({ fullWidth: true, margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), exports.ArrayInputClasses.root, className), error: (isDirty || isSubmitted) && !!error }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        ...
        React.createElement(ArrayInputContext_1.ArrayInputContext.Provider, { value: fieldProps }, (0, react_1.cloneElement)(react_1.Children.only(children), __assign(__assign({}, fieldProps), { record: record, resource: resourceFromProps, source: source, variant: variant, margin: margin, disabled: children.props.disabled || disabled, readOnly: children.props.readOnly || readOnly }))),
