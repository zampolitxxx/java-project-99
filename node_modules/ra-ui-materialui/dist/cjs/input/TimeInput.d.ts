...
export declare const TimeInput: {
    ({ className, defaultValue, format, label, helperText, margin, onBlur, onChange, source, resource, disabled, readOnly, parse, validate, variant, ...rest }: TimeInputProps): JSX.Element;
    propTypes: {
