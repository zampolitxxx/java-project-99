...
var BooleanInput = function (props) {
    ...
    var _d = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, format: format, parse: parse, resource: resource, source: source, onBlur: onBlur, onChange: onChange, type: 'checkbox', validate: validate, disabled: disabled, readOnly: readOnly }, rest)), id = _d.id, field = _d.field, isRequired = _d.isRequired, _e = _d.fieldState, error = _e.error, invalid = _e.invalid, isTouched = _e.isTouched, isSubmitted = _d.formState.isSubmitted;
...
exports.BooleanInput.propTypes = __assign(__assign({}, InputPropTypes_1.InputPropTypes), { 
    // @ts-ignore
    options: prop_types_1.default.shape(Switch_1.default.propTypes), disabled: prop_types_1.default.bool, readOnly: prop_types_1.default.bool });
var defaultOptions = {};
