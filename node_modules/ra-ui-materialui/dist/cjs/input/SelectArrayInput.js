...
var SelectArrayInput = function (props) {
    var _a;
    var choicesProp = props.choices, className = props.className, create = props.create, createLabel = props.createLabel, createValue = props.createValue, _b = props.disableValue, disableValue = _b === void 0 ? 'disabled' : _b, format = props.format, helperText = props.helperText, label = props.label, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, margin = props.margin, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, _c = props.options, options = _c === void 0 ? defaultOptions : _c, _d = props.optionText, optionText = _d === void 0 ? 'name' : _d, _e = props.optionValue, optionValue = _e === void 0 ? 'id' : _e, parse = props.parse, resourceProp = props.resource, _f = props.size, size = _f === void 0 ? 'small' : _f, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, variant = props.variant, disabled = props.disabled, readOnly = props.readOnly, rest = __rest(props, ["choices", "className", "create", "createLabel", "createValue", "disableValue", "format", "helperText", "label", "isFetching", "isLoading", "margin", "onBlur", "onChange", "onCreate", "options", "optionText", "optionValue", "parse", "resource", "size", "source", "translateChoice", "validate", "variant", "disabled", "readOnly"]);
    var inputLabel = (0, react_1.useRef)(null);
    var _g = (0, ra_core_1.useChoicesContext)({
        choices: choicesProp,
    ...
    var _j = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, parse: parse, resource: resource, source: source, validate: validate, disabled: disabled, readOnly: readOnly }, rest)), field = _j.field, isRequired = _j.isRequired, _k = _j.fieldState, error = _k.error, invalid = _k.invalid, isTouched = _k.isTouched, isSubmitted = _j.formState.isSubmitted, id = _j.id;
    ...
    var _l = (0, useSupportCreateSuggestion_1.useSupportCreateSuggestion)({
        create: create,
        ...
        onCreate: onCreate,
        optionText: optionText,
    }), getCreateItem = _l.getCreateItem, handleChangeWithCreateSupport = _l.handleChange, createElement = _l.createElement;
