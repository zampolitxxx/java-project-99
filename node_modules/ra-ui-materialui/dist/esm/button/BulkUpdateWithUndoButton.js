...
export var BulkUpdateWithUndoButton = function (props) {
    ...
    var _f = useUpdateMany(resource, { ids: selectedIds, data: data, meta: mutationMeta }, __assign({ onSuccess: onSuccess, onError: onError, mutationMode: 'undoable' }, otherMutationOptions)), updateMany = _f[0], isLoading = _f[1].isLoading;
