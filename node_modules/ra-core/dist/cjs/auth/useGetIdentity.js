...
var useGetIdentity = function (queryParams) {
    ...
    var result = (0, react_query_1.useQuery)(['auth', 'getIdentity'], function () { return __awaiter(void 0, void 0, void 0, function () {
        var identity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(authProvider &&
                        typeof authProvider.getIdentity === 'function')) return [3 /*break*/, 2];
                    return [4 /*yield*/, authProvider.getIdentity()];
                case 1:
                    identity = _a.sent();
                    return [2 /*return*/, identity || defaultIdentity];
                case 2: return [2 /*return*/, defaultIdentity];
            }
        });
